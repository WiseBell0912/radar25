...
for i = 487 : 487
    ...
    load("data_grid.mat");
    surf(data_grid_X, data_grid_Y, rot90(flip(img(:, :, 1))), 'EdgeAlpha', 0);
    view(0, 90)
    axis equal
    ...
    %PdirVal = mod(rad2deg(modifiy_theta) - rad2deg(atan2(kyDir, kxDir)), 360);
    PdirVal = mod((90 - rad2deg(atan2(kyDir, kxDir))) + 60, 360);
    ...
    disp([main, sub, nFile, i, PdirVal]);
end

toc;

if sub == 1
    save(['snr_y19', num2str(main), '_surf_0402.mat'], 'Date', 'SNR', 'Ux', 'Uy', 'Tp', 'Pdir');
elseif sub == 2
    save(['snr_y19', num2str(main), '_wave_0402.mat'], 'Date', 'SNR', 'Ux', 'Uy', 'Tp', 'Pdir');
end
